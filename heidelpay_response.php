...
if($returnvalue){
  ...
  if($payType == 'pc') $payType = 'mk'; // MangirKart Special
  ...
  if(strstr($returnvalue,"ACK")){
    ...
    } else if($_POST['PAYMENT_CODE'] == 'OT.RC' && ($_POST['ACCOUNT_NUMBER'] != '' || $_POST['ACCOUNT_IBAN'] != '')){
      // LS Daten speichern
    ...
    } else if($_POST['PAYMENT_CODE'] == 'IV.PA' && $_POST['ACCOUNT_BRAND'] == 'BILLSAFE'){
    ...
    } else if($_POST['PAYMENT_CODE'] == 'CC.RG' || $_POST['PAYMENT_CODE'] == 'DC.RG'){
